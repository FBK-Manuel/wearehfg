    ...
    <footer className="bg-[#d24d0a] text-white">
      ...
      <div className="bg-gray-900 py-10 px-6 ">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#d24d0a] hover:bg-[#FF6200] px-6 py-3 rounded-lg text-white font-semibold transition"
            >
              {loading ? (
                <>
                  <AiOutlineLoading
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <h3 className="text-lg font-semibold mb-3 mt-5">Information</h3>
          <div>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
      ...
      <div className="bg-[#c13f05] py-4 text-center text-sm">
        © {new Date().getFullYear()} Wearehfg. All rights reserved.
      </div>
    </footer>
  );
};
